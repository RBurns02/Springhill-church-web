  ...
  return (
    <>
      ...
      <section className="page-header">
        <p className="eyebrow text-church-gold mb-5">Generosity Changes Everything</p>
        <h1 className="font-serif text-5xl md:text-6xl font-bold mb-4 tracking-tight">Give</h1>
            ...
            {giftImpacts.map((item, i) => (
              <ScrollReveal key={item.title} delay={i * 70}>
                <div className="card p-8 text-center group">
                  ...
                  <h3 className="font-serif font-bold text-lg text-stone-900 mb-3">{item.title}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-5">
          <ScrollReveal>
            <div className="card p-10 md:p-14 text-center border-church-gold/30" style={{ borderColor: 'rgba(201,168,76,0.3)', borderWidth: '1px' }}>
              <div className="w-14 h-14 border border-stone-200 flex items-center justify-center mx-auto mb-7">
              ...
              <p className="eyebrow text-church-gold mb-4">Recommended</p>
              <h2 className="font-serif text-3xl font-bold text-stone-900 mb-3 tracking-tight">Give Online</h2>
              ...
              <p className="text-xs text-stone-400 mt-5">You&apos;ll be taken to our secure Tithe.ly giving page.</p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mt-4">
            <ScrollReveal delay={60}>
              <div className="card p-7">
                <div className="w-10 h-10 border border-stone-200 flex items-center justify-center mb-5">
                ...
                <h3 className="font-semibold text-stone-900 mb-2">Give in Person</h3>
            ...
            <ScrollReveal delay={120}>
              <div className="card p-7">
                ...
                <h3 className="font-semibold text-stone-900 mb-2">Mail a Check</h3>
                <p className="text-stone-500 text-sm leading-relaxed">
      ...
      <section className="py-20 section-dark">
        <div className="max-w-4xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {verses.map((v, i) => (
              <ScrollReveal key={v.ref} delay={i * 80}>
                <div className="border border-white/10 p-7 text-center hover:border-church-gold/30 transition-colors">
                  <svg className="w-6 h-6 text-church-gold mx-auto mb-5 opacity-60" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                  </svg>
                  <p className="text-white/65 text-sm leading-relaxed italic mb-5">{v.text}</p>
                  <p className="text-church-gold text-xs font-semibold tracking-wide uppercase">{v.ref}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
