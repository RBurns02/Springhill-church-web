  ...
  if (!posts || posts.length === 0) {
    return (
      <a
        ...
        className="flex items-center justify-center gap-3 py-10 border border-stone-200 text-stone-500 hover:text-church-gold hover:border-church-gold transition-all text-sm font-semibold tracking-wide"
      >
