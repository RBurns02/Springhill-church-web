...
const serviceTimes = [
  { label: 'Sunday Morning',    time: '10:00 AM' },
  { label: 'Sunday Evening',    time: '6:00 PM'  },
  { label: 'Wednesday Night',   time: '7:30 PM'  },
];
...
export default function Footer() {
  return (
    <footer className="bg-church-dark text-stone-300">
      ...
      <div className="max-w-6xl mx-auto px-5 py-16 grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-10 md:gap-8">
        ...
        <div className="flex flex-col gap-5">
          ...
          <p className="text-sm text-stone-500 leading-relaxed max-w-xs">
            A Spirit-filled community in Wesson, MS. Everyone is welcome — come as you are.
          </p>
        ...
        {/* ── Navigate ── */}
        <div>
          <p className="text-[10px] font-bold tracking-[0.18em] uppercase text-stone-500 mb-5">Navigate</p>
        ...
        {/* ── Services ── */}
        <div>
          <p className="text-[10px] font-bold tracking-[0.18em] uppercase text-stone-500 mb-5">Services</p>
          <ul className="space-y-4">
            ...
            <li className="pt-3 border-t border-white/[0.07]">
              <p className="text-xs text-church-gold font-semibold">1st Sunday Monthly</p>
              <p className="text-xs text-stone-500 mt-0.5">Friends &amp; Family · 2:00 PM</p>
            </li>
          </ul>
        </div>
        ...
        {/* ── Find Us ── */}
        <div>
          <p className="text-[10px] font-bold tracking-[0.18em] uppercase text-stone-500 mb-5">Find Us</p>
          <address className="not-italic space-y-4">
            <div>
              <p className="text-sm text-stone-300 font-medium">Pastor Tommy Lee</p>
            ...
            <div>
              <Link href="/prayer"
                className="text-xs font-semibold text-church-gold hover:text-amber-400 transition-colors">
      ...
      {/* ── Bottom bar ── */}
      <div className="border-t border-white/[0.06] py-5 text-center text-xs text-stone-600">
        © {new Date().getFullYear()} Springhill Pentecostal Church · Wesson, MS
      </div>
