...
export default function Footer() {
  return (
    <footer className="bg-church-dark text-stone-400 text-sm">
      ...
      {/* ── Social bar ── */}
      <div className="border-b border-white/[0.07] py-5 flex justify-center gap-7">
      ...
      {/* ── Main row ── */}
      <div className="max-w-6xl mx-auto px-5 py-8 flex flex-col md:flex-row md:items-center gap-6 md:gap-0 md:justify-between border-b border-white/[0.07]">
      ...
      {/* ── Info row ── */}
      <div className="max-w-6xl mx-auto px-5 py-5 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-0 sm:justify-between text-xs text-stone-500">
        <div className="flex flex-wrap gap-x-5 gap-y-1">
          <span>Sun · 10:00 AM &amp; 6:00 PM</span>
          <span className="hidden sm:inline text-stone-700">·</span>
          <span>Wed · 7:30 PM</span>
          <span className="hidden sm:inline text-stone-700">·</span>
          <span className="text-church-gold/80">1st Sun · Friends &amp; Family 2:00 PM</span>
        </div>
