...
export default function Footer() {
  return (
    <footer className="bg-church-dark text-stone-300">
      ...
      <div className="border-b border-white/10 py-6 flex flex-col items-center gap-3">
        ...
        <div className="flex gap-4">
          <a href="https://www.instagram.com/spcwesson" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
            className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-church-purple transition-colors">
